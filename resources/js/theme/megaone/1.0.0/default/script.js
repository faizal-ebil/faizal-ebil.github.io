...
$(window).on('load',function(){
  ...
  //If Index Window Location More Than Zero
  if(index > 0){
  ...
  **************************************************************/
  ...
  //If Window Width Less Than 1020
  if($(window).width() < 1020){

    //Remove Page ID Page Data
    ...
    $('#pagepiling').pagepiling(
      {
        ...
        //Every Section Color in Order
        sectionsColor:['#FFA500','#FFA500','#FFA500','#FFA500','#FFA500'],
        ...
        navigation:{
          'bulletsColor':'#535353',
          'position':'right',
          'tooltips': ['Home','About','Experience','Timeline','Portfolio','Contact']
        },
        ...
        onLeave:function(index,nextIndex,direction){
          ...
          //If Page Index Next is 4
          if(nextIndex == 4){

            //Main Scrolling Disabled
            $.fn.pagepiling.setAllowScrolling(false);

          }
          else{

            //Main Scrolling Enable
            $.fn.pagepiling.setAllowScrolling(true);

          }

          //If Next Index Within the Order
          if(nextIndex == 1 || nextIndex == 2 || nextIndex == 3 || nextIndex == 4 || nextIndex == 5 || nextIndex == 6){
            setTimeout(function(){
...
jQuery(function($){
  ...
  //Page 4 Setting
  $('#page4.timeline ul').on('scroll',function(){

    //If Height Reach Zero
    if($(this).scrollTop() === 0){

      //Message Debugging
      console.log('Reach Top:Enable Main Scroll');
      ...
      //Message Debugging
      console.log('Reach Bottom:Enable Main Scroll');
      ...
      //Message Debugging
      console.log('Reach Middle:Disable Main Scroll');

      //Main Scrolling Disabled
      $.fn.pagepiling.setAllowScrolling(false);

      //Find Element Timeline
  ...
  **************************************************************/
  ...
  $('#expertise_slider .owl-dot').addClass('link');
  ...
  **************************************************************/
  $(document).ready(function(){
    ...
    /*  Animated Cursor - Check Window Width
    **************************************************************/
    if($(window).width() > 991){
      animatedCursor();
    }
  ...
  **************************************************************/
  ...
  /*  Animated Cursor - Set Timeout Check Window Width
  **************************************************************/
  if($(window).width() > 991){
    setTimeout(function(){
      animatedCursor();
  ...
  **************************************************************/
  ...
  if($(mainSlider).length){
    ...
    //Execute Main Slider Revolution
    ...
    /*  Before or After Initialisation
    **************************************************************/
  ...
  /**************************************************************
    End Main Slider Four Revolution
  **************************************************************/
